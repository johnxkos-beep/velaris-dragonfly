...
const (
	...
	knockbackScale    = 0.35 // fraction of a normal hit's knockback he actually takes (he's a boss, not a chicken)
	knockbackDecay    = 0.65 // velocity multiplier applied each tick while reeling from a hit
