...
const (
	...
	knockbackScale    = 1.0 // fraction of a normal hit's knockback he takes (was 0.35 — too subtle to notice, now full strength)
	knockbackDecay    = 0.8 // velocity multiplier applied each tick while reeling from a hit (higher = travels further before stopping)
...
func (e *DemonKing) useAbility(tx *world.Tx) {
	...
	// two abilities at least feel distinct from a plain melee hit.
	//
