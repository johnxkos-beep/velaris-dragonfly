...
func newState() *fightState {
	return &fightState{Phase: phaseOne, HP: phaseHealth, MaxHP: phaseHealth}
}
...
// really relevant to a boss, but required by the interface.
func (e *DemonKing) Heal(health float64, src world.HealingSource) {
	e.fight.HP += health
