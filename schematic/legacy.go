...
// toByteSlice accepts whichever native Go type the NBT decoder actually
// produces for a TAG_Byte_Array — []byte/[]uint8 or []int8 — and returns
// it as a plain []byte (re-widening signed bytes to their unsigned bit
// pattern, since block IDs/metadata are conceptually unsigned 0-255).
