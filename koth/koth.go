...
// above its highest corner — where that zone's per-zone ticker entity
// gets anchored (see ticker.go's SpawnZoneTicker). Anchoring it here
// instead of at some unrelated player's join position is the actual fix
// for the "doesn't camp" bug — see the package doc comment's BUGFIX note.
