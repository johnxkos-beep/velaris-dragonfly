...
// GenerateChunk is wrapped with the same recover-and-log safety net as
// Overworld.GenerateChunk - see the comment there for why.
...
func (n Nether) GenerateChunk(pos world.ChunkPos, c *chunk.Chunk) {
	...
	wastes := findBiome("nether_wastes", "hell")
	soulValley := findBiome("soulsand_valley", "soul_sand_valley")
