...
func (o Overworld) DefaultSpawn() cube.Pos {
...
func (o Overworld) GenerateChunk(pos world.ChunkPos, c *chunk.Chunk) {
	...
	plains, _ := world.BiomeByName("minecraft:plains")
	forest, _ := world.BiomeByName("minecraft:forest")
	desert, _ := world.BiomeByName("minecraft:desert")
	hills, _ := world.BiomeByName("minecraft:extreme_hills")
	ocean, _ := world.BiomeByName("minecraft:ocean")
