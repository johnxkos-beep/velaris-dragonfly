...
func OnUse(tx *world.Tx, p *player.Player) bool {
	...
	id := w.WeaponDef().ID
	EnsureCrosshair(tx, p) // starts the always-on crosshair ticker the first time any legendary is used — see crosshair.go's doc comment for why here specifically
