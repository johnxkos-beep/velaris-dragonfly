...
func main() {
	...
	// console on mobile.
	logFile, err := os.OpenFile("velaris.log", os.O_CREATE|os.O_WRONLY|os.O_TRUNC, 0644)
	if err != nil {
		// Fall back to stdout-only if the file can't be opened; don't
		// block startup over logging.
		logFile = nil
	}
