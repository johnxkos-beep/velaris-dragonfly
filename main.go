...
func dimensionGenerator(dim world.Dimension) world.Generator {
	...
	case world.End:
		return worldgen.NewFlat(biome.TheEnd(), []world.Block{dfblock.EndStone{}})
	default:
		return worldgen.NewFlat(biome.Plains(), []world.Block{dfblock.Grass{}, dfblock.Dirt{}, dfblock.Dirt{}})
	}
}
...
func main() {
	...
	userConf.World.Generator = dimensionGenerator
