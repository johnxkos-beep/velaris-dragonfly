...
// NOTE: form.Button's label is accessed here as pressed.Text() (a getter
// over an unexported field, matching Menu's Title()/Body() pattern) rather
// than pressed.Text. Flag this if it doesn't compile and we'll swap to
// whichever form the real API uses.
