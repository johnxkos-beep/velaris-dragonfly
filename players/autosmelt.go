...
// TEMP DIAGNOSTIC: prints unconditionally at process startup, before any
// player even joins. If this line is NOT in the console output right after
// the "Dragonfly server started" line, this file isn't part of the running
// binary — a build/deploy problem, not a logic problem. Remove once
// confirmed working.
func init() {
	println("[autosmelt] autosmelt.go compiled in and loaded")
}
