...
//
// world.BlockByName(name string, properties map[string]any) (world.Block,
// bool) is confirmed against the real, current Dragonfly API docs.
//
// This is NOT a full Java->Bedrock converter — EasyEdit's real one
// (convert/block/*.php) is a hand-built mapping table covering hundreds of
// state differences between the two editions. Plain blocks (stone, dirt,
// planks, wool, concrete, logs, most simple furniture) share the same
// namespaced ID between editions and will paste correctly. Blocks whose
// property schema diverges between Java and Bedrock (stairs, some redstone
// components, a handful of renamed blocks) may come out wrong or get
// skipped. Send me the SkippedNames list after a paste and I'll extend this
// table for the specific blocks you actually use.
