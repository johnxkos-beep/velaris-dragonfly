...
// creativeGroupName is a unique name for the creative-inventory group both
// spawn eggs belong to. Confirmed against the real Dragonfly source
...
// the creative inventory under their own group. Call this once at
// startup, alongside the other world.RegisterItem/Register calls (e.g.
...
func Register() {
	...
	// One shared group for both eggs, shown in the Items tab (matches each
	// egg's own Category() in spawneggs.go). Icon is just which item
