...
// (brown/cream for cow, cream/red for chicken) generated for this project,
// not pulled from the real game files — swap in the real vanilla PNGs
// later if you'd rather match Bedrock's own icons exactly.
//
