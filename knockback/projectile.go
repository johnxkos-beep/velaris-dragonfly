...
// held item's type.
//
// ExperienceBottle and Trident were dropped from the original list — your
// installed Dragonfly version doesn't have those item types (compiler
// confirmed this, not a guess). If a future update adds them, add cases
// here for whatever they end up being named.
func isProjectileItem(it world.Item) bool {
	switch it.(type) {
